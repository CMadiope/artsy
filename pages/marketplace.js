...
const marketplace = () => {
  return (
    <div className='pt-10'>
      <div className='md:flex md:justify-between max-md:items-center '>
        <div className='flex  w-53 h-15 items-center gap-2  bg-input rounded-md p-2 max-md:hidden'>
      ...
      <div className='flex justify-center p-10 '>
        <button className='border p-2 rounded-lg pl-4 pr-4 hover:bg-slate-50'>
          See more
        </button>
      </div>
    </div>
